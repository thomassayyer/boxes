    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                {
                    //TODO: l'application n'a pas été lancée en mode prélancement.
                }
            ...
            if (rootFrame.Content == null)
            {
                ...
                rootFrame.Navigate(
                    ApplicationData.Current.LocalSettings.Values.ContainsKey("CurrentUser") ?
                    typeof(Views.Shell) :
        ...
        private void InitializeTitleBar()
        {
            ...
            titleBar.BackgroundColor = ((SolidColorBrush)this.Resources["PrimaryBrush"]).Color;
            titleBar.ForegroundColor = Colors.White;
            titleBar.ButtonBackgroundColor = ((SolidColorBrush)this.Resources["PrimaryBrush"]).Color;
            titleBar.ButtonForegroundColor = Colors.White;
            titleBar.ButtonHoverBackgroundColor = ((SolidColorBrush)this.Resources["DarkPrimaryBrush"]).Color;
            titleBar.ButtonHoverForegroundColor = Colors.White;
            titleBar.ButtonPressedBackgroundColor = ((SolidColorBrush)this.Resources["DarkPrimaryBrush"]).Color;
